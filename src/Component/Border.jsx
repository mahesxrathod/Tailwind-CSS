...
function Border() {
  return (
    ...
    <div className='flex flex-col justify-between content-between'>
        ...
        <div className='w-[80%] mx-auto outline-2 outline-offset-2 bg-[gold] border-indigo-600  text-center text-red font-bold text-2xl p-5 mb-3 mt-3'>Outline offset</div>
        <div className='w-[80%] mx-auto outline-4 outline-offset-2 bg-[gold] border-indigo-600  text-center text-red font-bold text-2xl p-5 mb-3 mt-3'>Outline offset</div>
    </div>
    </>
  )
}
